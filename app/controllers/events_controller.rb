class EventsController < ApplicationController
  ...
  def index
    ...
    #
    # Page number and format ride the etag — otherwise the full HTML page and the
    # Turbo Stream append would 304 off each other. catalog_fresh? folds the
    # freshness stamp in on top.
